...
<div style="margin: 30px 50px">
	<button type="button" class="btn btn-secondary btn-sm" style = "width: 120px" onclick = "location.href='boardform.jsp'">
	<i class="bi bi-pencil-fill"></i>&nbsp;글쓰기
	</button>
	
	<table class="table table-bordered" style="width: 700px; margin: 20px;">
		<caption align="top"><b>
		<%=list.size() == 0? "Simple Board" : "총" + list.size() + "개의 게시글이 있습니다" %></b></caption>
