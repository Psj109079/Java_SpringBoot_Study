		...
		<form action="updateMember" method="post" enctype="multipart/form-data">
			...
			<table class="table table-bordered">
				...
				<tr>
					...
					<td>
						<input type="text" name="name" required="required" autofocus="autofocus" class="form-control" style="width:120px;" value="${dto.name}">
					</td>
					
					<td rowspan="4">
						<input type="file" name="upload" class="form-control" onchange="readUrl(this)" style="width: 170px;">
						<br>
						<img src="../photo/${dto.photo}"  id="showimg" style="width:120px; height: 150px; margin-left:30px" onerror="this.src='../photo/noimage.png'" >
				...
				<tr>
					...
					<td>
						<div class="input-group">
							<input type="email" name="email" id="email" required="required" class="form-control" value="${dto.email}">
				...
				<tr>
					...
					<td>
						<input type="text" name="hp" required="required" class="form-control" value="${dto.hp}">
					</td>
				</tr>
				<tr>
