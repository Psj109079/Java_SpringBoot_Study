...
<body>
<i class="bi bi-house" style="font-size: 30px; cursor: pointrer; color: red; margin: 30px 50px;"
	onclick="location.href='/bit701'"></i>
<div class="loginbox">
	<form action="loginaction" method="post">
		<table class="table" style="width: 300px">
			<caption align="top"><b>회원 로그인</b>
				<span><label><input type="checkbox" name="saveemail"
			...
			<tr>
				<td colspan="2" align="center">
					<button type="submit" class="btn btn-outline-secondary" style="width: 120px">
					회원로그인</button>
				</td>
			</tr>
		</table>
