	...
	<c:if test="${sessionScope.loginok!=null}">
		...
		<form action="updateboard" method="post" enctype="multipart/form-data">
			...
			<table class="table table-bordered" style="width: 500px; margin: 30px 30px">
				<caption align="top"><h4><b>글수정</b></h4></caption>
				<tr>
					<td>
						<input type="text" name="subject" class="form-control" value="${dto.subject}" placeholder="제목을 입력해주세요" required="required">						
					</td>
				</tr>
				<tr>
					<td>
				...
				<tr>
					<td align="center">
						<button type="submit" class="btn btn-outline-success" style="width:130px;">글수정</button>
						<button type="reset" class="btn btn-outline-success" style="width:130px;">취소</button>
						<button type="button" class="btn btn-outline-success" style="width:130px;" onclick="location.href='list?currentPage=${currentPage}'">목록으로</button>
					</td>
				</tr>
			</table>
		</form>
